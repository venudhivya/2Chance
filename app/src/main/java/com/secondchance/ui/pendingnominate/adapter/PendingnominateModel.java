...
public class PendingnominateModel {
    ...
    public PendingnominateModel(Activity activity, ArrayList<String> usernameList, ArrayList<String> dobList, ArrayList<String> imageList, String useraction) {
